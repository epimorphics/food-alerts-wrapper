...
require = (function r(s, a, l) {
...
})(
    {
        'sphinx-rtd-theme': [
            function (n, e, i) {
                var jQuery =
                    'undefined' != typeof window ? window.jQuery : n('jquery');
                (e.exports.ThemeNav = {
                    navBar: null,
                    win: null,
                    winScroll: !1,
                        ...
                        try {
                            ...
                            if (0 === i.length) {
                                ...
                                0 ===
                                    (i = e.find(
                                        '[href="#' + t.attr('id') + '"]'
                                    )).length && (i = e.find('[href="#"]'));
                            }
                            0 < i.length &&
                                ($('.wy-menu-vertical .current').removeClass(
                                    'current'
                                ),
                                i.addClass('current'),
                        ...
                        for (
                            ...
                            (window.requestAnimationFrame =
                                ...
                                (window.cancelAnimationFrame =
                                    ...
                                    window[
                                        n[e] + 'CancelRequestAnimationFrame'
                                    ]);
                        window.requestAnimationFrame ||
